...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference("Adventure.count") do
      post adventures_url, params: { adventure: { active: @adventure.active, user_id: @adventure.user_id } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { active: @adventure.active, user_id: @adventure.user_id } }
