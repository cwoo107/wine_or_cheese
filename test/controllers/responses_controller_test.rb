...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference("Response.count") do
      post responses_url, params: { response: { content: @response.content, message_id: @response.message_id } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { content: @response.content, message_id: @response.message_id } }
